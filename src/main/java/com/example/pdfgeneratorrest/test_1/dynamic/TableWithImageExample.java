...
public class TableWithImageExample {
    public static void main(String[] args) {
        ...
        try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
            ...
            try (InputStream imageStream = TableWithImageExample.class.getResourceAsStream("sample.jpg")) {
                if (imageStream != null) {
            ...
            try {
                document.save("table_with_image_example.pdf");
                document.close();
            } catch (IOException e) {
                e.printStackTrace();
            }
